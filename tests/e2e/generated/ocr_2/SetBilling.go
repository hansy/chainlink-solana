...
// SetObservationPayment sets the "observationPayment" parameter.
func (inst *SetBilling) SetObservationPayment(observationPayment uint32) *SetBilling {
	inst.ObservationPayment = &observationPayment
	return inst
}
...
func (inst *SetBilling) Validate() error {
	...
	{
		if inst.ObservationPayment == nil {
			return errors.New("ObservationPayment parameter is not set")
		}
	}
			...
			programBranch.Child(ag_format.Instruction("SetBilling")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Params[len=1]").ParentFunc(func(paramsBranch ag_treeout.Branches) {
						paramsBranch.Child(ag_format.Param("ObservationPayment", *inst.ObservationPayment))
					})
...
func NewSetBillingInstruction(
	...
	return NewSetBillingInstructionBuilder().
		SetObservationPayment(observationPayment).
